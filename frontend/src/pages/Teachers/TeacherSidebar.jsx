     ...
     return (
          <SidebarContainer style={{ width: isopen ? "250px" : "80px" }}>
               ...
               <SidebarNav>
                    <SidebarNavItem>
                         <BsGraphUp />
                         <StyledLink to="/teacher/dashboard">
                              Dashboard
                         </StyledLink>
                    </SidebarNavItem>
                    <SidebarNavItem>
                    ...
                    <SidebarNavItem>
                         <BsPerson />
                         <StyledLink to="/teacher/students">
                              Students
                         </StyledLink>
                    </SidebarNavItem>
                    <SidebarNavItem>
                         <BsPerson />
                         <StyledLink to="/teacher/teachers">
                              Teachers
                         </StyledLink>
                    </SidebarNavItem>
                    ...
                    <SidebarNavItem>
                         <BsBook />
                         <StyledLink to="/teacher/assignments">
                              Assignments
                         </StyledLink>
                    </SidebarNavItem>
                    <SidebarNavItem>
                    ...
                    <SidebarNavItem>
                         ...
                         <StyledLink to="/teacher/performance">
                              Performance
                         </StyledLink>
                    </SidebarNavItem>
                    ...
                    <SidebarNavItem>
                         ...
                         <StyledLink to="/teacher/attendence">
                              Attendence
                         </StyledLink>
                    </SidebarNavItem>
                    ...
                    <SidebarNavItem>
                         ...
                         <StyledLink to="/teacher/communication">
                              Announcements
                         </StyledLink>
                    </SidebarNavItem>
                    ...
                    <SidebarNavItem>
                         ...
                         <StyledLink to="/teacher/settings">
                              Setting and Profile
                         </StyledLink>
                    </SidebarNavItem>
                    <ToggleButton
